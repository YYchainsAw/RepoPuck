...
从下方 Assets 下载 `RepoPuck_0.2.2_windows-x64.msi`。
...
> [!WARNING]
> 当前 MSI 尚未进行 Windows 代码签名，SmartScreen 可能显示“未知发布者”。请只从本仓库 Releases 下载，并使用随附的 `SHA256SUMS.txt` 校验文件。
...
Download `RepoPuck_0.2.2_windows-x64.msi` from the assets below.
